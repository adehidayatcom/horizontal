...
1. `docs/schema_mapping.md`
2. `docs/business_contracts.md`
3. `docs/query_contracts.md`
4. `docs/integration_contract_pack.md`
...
- API ke frontend menggunakan `snake_case` penuh (DL direkam di `support/decision_log.md`)
...
- apakah direct Supabase browser client boleh dipakai untuk read sederhana tertentu atau semua read wajib lewat internal route (catat di `support/open_questions_register.md` jika perlu formal decision)
