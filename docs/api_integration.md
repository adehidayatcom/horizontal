...
Gunakan envelope dari `docs/integration_contract_pack.md`.
...
Nama RPC final harus mengikuti `docs/business_contracts.md` dan blueprint modul yang sudah aktif.
...
Nama hook disarankan mengikuti `docs/integration_read_model_matrix.md`.
