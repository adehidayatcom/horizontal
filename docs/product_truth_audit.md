...
- wording di `docs/period_workflow.md` diselaraskan agar alur reseller tidak lagi terkesan "pesanan dulu"
- wording di `docs/data_flow.md` diselaraskan agar reseller `PENDING` diblok pada `pesanan/setoran`, bukan hanya `setoran`
- wording di `docs/schema_mapping.md` diselaraskan agar pendaftaran reseller dan tabel `konsumen` tidak menyiratkan order sebagai langkah awal tunggal
...
1. `docs/prd.md` untuk arah produk.
2. `docs/program_workflow.md` dan `docs/period_workflow.md` untuk lifecycle domain.
3. `docs/schema_mapping.md` untuk struktur data dan formula.
4. `docs/business_contracts.md` untuk aksi write/RPC.
5. `docs/query_contracts.md` untuk read model.
6. `docs/integration_contract_pack.md` untuk boundary lintas layer.
...
2. `support/decision_log.md` untuk keputusan lintas-dokumen yang sudah dikunci
